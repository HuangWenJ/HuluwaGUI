...
public class Field extends JPanel {
    ...
    public final void initWorld() {
        ...
        for(int i=0;i<7;i++){
        	players.add(new Player("葫芦娃"+(i+1),0,i*OFFSET, this,"huluwa"+(i+1)+".png",0,15));
        }
        Player grandpa=new Player("老爷爷",0,7*OFFSET,this,"grandpa.png",0,15);
        players.add(grandpa);
        Player shejing=new Player("蛇精",11*OFFSET,3*OFFSET,this,"shejing.png",1,15);
        shejing.setDirLeft();
        players.add(shejing);
        Player xiezijing=new Player("蝎子精",11*OFFSET,4*OFFSET,this,"xiezijing.png",1,15);
